...
namespace Warlander.Deedplanner.Graphics.Water
{
    ...
    /// Plain C# class — not a MonoBehaviour. Created and owned by WaterFacade; injected into WaterController.
    /// Call RenderForCamera() from WaterController when Ultra quality is active.
    /// </summary>
