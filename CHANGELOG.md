...
- Cave level controls and cave editing are now enabled, with synchronized Ground/Caves switching, consistent solid-rock painting across camera modes, and correct surface rendering
